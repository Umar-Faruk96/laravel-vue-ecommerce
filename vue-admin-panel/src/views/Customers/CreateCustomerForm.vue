            ...
            >
              ...
              <header class="py-3 px-4 flex justify-between items-center">
                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-black/90">
                  {{ customer.id ? `Edit Customer: "${props.customer.name}"` : "Create new Customer" }}
                </DialogTitle>
              ...
              <form @submit.prevent="submit">
                <main class="bg-white/80 px-4 pt-5 pb-4">
                  ...
                  <CustomInputNew
                      type="password"
                      v-model:password="customer.password"
                      label="Password"
                      name="password"
                  ...
                  <CustomInputNew
                      v-model:confirm-password="customer.password_confirmation"
