  ...
  <section class="bg-black/10 p-4 rounded-lg shadow animate-fade-in-down">
    <div class="flex justify-between border-b-2 pb-3">
      <section class="flex items-center">
        ...
        <span class="ml-3 text-black/60"
          >Found {{ products.meta.total }} products</span
        >
      </section>
    ...
    <section v-if="!products.loading" class="flex justify-between items-center mt-5">
      <span class="text-black/40"
        >Showing from {{ products.meta.from }} to {{ products.meta.to }}</span
      >

      <nav
        v-if="products.meta.total > products.meta.per_page"
