              ...
              <div class="flex h-6 shrink-0 items-center">
                <div class="checkbox grid size-4 grid-cols-1">
                  <input v-model="user.remember" id="remember-me" name="remember-me" type="checkbox"
                    class="col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 bg-gray-50 checked:border-indigo-500 checked:bg-indigo-500 indeterminate:text-indigo-500 indeterminate:bg-indigo-500 focus-visible:outline focus-visible:outline-indigo-500 focus-visible:outline-offset-2 disabled:text-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto" />
